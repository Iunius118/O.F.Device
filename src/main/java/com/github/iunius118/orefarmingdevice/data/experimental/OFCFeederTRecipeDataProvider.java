...
public class OFCFeederTRecipeDataProvider {
    ...
    public static void addProviders(final GatherDataEvent.Client event) {
        ...
        packGenerator.addProvider((o) -> new OFCFeederTRecipeDataProvider.FeederTRecipeProviderRunner(packOutput, lookupProvider));
    }
    ...
    private static class FeederTRecipeProviderRunner extends RecipeProvider.Runner {
        protected FeederTRecipeProviderRunner(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries) {
            super(packOutput, registries);
        }

        @Override
        protected RecipeProvider createRecipeProvider(HolderLookup.Provider registryLookup, RecipeOutput output) {
            return new VanillaRecipeProvider(registryLookup, output) {
                @Override
